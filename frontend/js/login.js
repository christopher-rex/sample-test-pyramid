const login = (_ => {
	...
	return {
		init() {
			document.querySelector('#login-form').addEventListener('submit', listeners.handleSubmit)
		...
		cleanup() {
			document.querySelector('#login-form').removeEventListener('submit', listeners.handleSubmit)
